...
/** Ce que chaque forme montre, dit sans jargon : l'écran s'adresse à l'accueil. */
export const TEXTES_MARQUE: Record<Marque, { nom: string; usage: string }> = {
  ...
  nuage: { nom: 'Nuage de points', usage: 'Un point par croisement, pour voir les écarts' },
  ...
  jauge: { nom: 'Jauge', usage: 'Où on en est par rapport à un repère' },
