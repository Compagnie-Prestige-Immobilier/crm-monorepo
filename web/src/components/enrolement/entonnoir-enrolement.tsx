...
import type { EnrolementIndicateurs } from '@/lib/data/enrolement';
...
const ETAGES: readonly Etage[] = [
  { cle: 'inscriptions', label: 'Comptes créés', aide: 'Une inscription lue sur la plateforme.' },
  {
    cle: 'dossiersOuverts',
  ...
  { cle: 'dossiersDecides', label: 'Décidés', aide: 'Une décision est datée sur la plateforme.' },
];
        ...
        {total === 0 ? (
          ...
          <ul className="flex flex-col gap-3">
            {ETAGES.map((etage, index) => {
              ...
              return (
                <li key={etage.cle} className="flex flex-col gap-1.5">
