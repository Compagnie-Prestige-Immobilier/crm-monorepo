...
export function MotifFormDialog({
  ...
  const enregistrer = useMutation({
    mutationFn: () => {
      // Un motif système garde sa règle : la renvoyer, même intacte, est refusé.
      const regles = motif?.isSystem
        ? {}
        : {
      ...
      const commun = { label: brouillon.label.trim(), color: brouillon.color, ...regles };
      return motif === null
