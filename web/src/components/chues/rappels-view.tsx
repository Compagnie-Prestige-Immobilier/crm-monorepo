  ...
  const base: Colonne<Rappel>[] = [
    {
      ...
      cellule: (rappel) => (
        <>
          <span className="font-[600]">{rappel.prospectName || formatPhone(rappel.phoneE164)}</span>
          <span className="block text-[0.75rem] font-[400] text-muted-foreground tabular-nums">
            {formatPhone(rappel.phoneE164)} · Fiche {rappel.shortCode}
          </span>
        </>
      ),
    },
