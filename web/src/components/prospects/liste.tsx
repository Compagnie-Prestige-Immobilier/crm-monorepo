...
export function ListeProspects({
  ...
  // Le projet est posé ici : oublié, la liste CHUES rendrait aussi les fiches Grand Public.
  const requete = { ...filtres, projet: PROJET_API[projet] };
  const liste = useQuery({
    queryKey: queryKeys.prospects(requete),
    queryFn: () => fetchProspects(requete),
