...
export const Route = createFileRoute('/_panneau/chues/representants/$id')({
  beforeLoad: guardRoles(['ADMIN', 'COMMERCIAL', 'CHARGE_CLIENTELE', 'SUPERVISEUR', 'DIRECTION']),
  component: RepresentantPage,
...
/** La page `(panel)/chues/representants/[id]` de la v1. */
function RepresentantPage() {
