...
export const Route = createFileRoute('/_panneau/chues/representants/import')({
  beforeLoad: guardRoles(['ADMIN']),
  component: RepresentantsImportPage,
...
/** La page `(panel)/chues/representants/import` de la v1. */
function RepresentantsImportPage() {
