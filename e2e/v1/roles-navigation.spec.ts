...
const CAS: readonly Cas[] = [
  {
    ...
    session: 'v1/.auth/commercial.json',
    route: '/chues',
    principales: [
      'Mon travail',
      'Qualifier un représentant',
  ...
  },
  {
    ...
    session: 'v1/.auth/superviseur.json',
  ...
  },
  {
    id: 'ROL-08 · direction',
    intitule: 'barre CHUES de l’encadrement',
    session: 'v1/.auth/direction.json',
    route: '/chues/statistiques',
    principales: [
      'Tableau de bord',
      'Qualifier un représentant',
  ...
  },
  {
    ...
    session: 'v1/.auth/commercial.json',
    route: '/grand-public',
    principales: ['Prospects', 'Rappels promis'],
    repliees: ['Mes contacts'],
    absentes: ['Tableau de bord', 'Mon travail', 'Appeler les prospects', 'Noter un prospect'],
    courant: 'Prospects',
  },
  {
