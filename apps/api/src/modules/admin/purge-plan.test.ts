...
const PURGE_EXEMPT = new Map<string, string>([
  ...
  [
    ...
    'temps de présence observé, une ligne par compte et par heure, en `onDelete: Cascade` : elle part avec le compte. Comme `agent_heartbeats`, elle mesure la présence de l’application, pas une donnée métier, et lui donner une étape à elle seule effacerait le temps de travail de comptes toujours en service',
  ],
  [
    'device_tokens',
