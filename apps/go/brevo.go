...
func configurerBrevo() brevo {
	b := brevo{
		...
		nom:        env("BREVO_SENDER_NAME", brevoNomExpediteurDefaut),
		url:        env("BREVO_ENDPOINT", brevoUrlDefaut),
	}
	millisecondes, err := envInt("BREVO_REQUEST_TIMEOUT_MS", brevoDelaiDefaut)
	if err != nil {
