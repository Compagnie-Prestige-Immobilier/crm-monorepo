...
var seedBanques = []seedBanque{
	{"CBAO, Groupe Attijariwafa Bank", exportCleCbao, 1},
...
var seedSyndicats = []seedSyndicat{
	...
	{"Autre structure", banqueMotifAutre, seedLibelleAutre, 900},
...
var seedBankStages = []seedBankStage{
	...
	{"EN_TRAITEMENT_BANQUE", "En traitement banque", "warning", 2, db.BankStageTypeOPEN, false, false},
	{"ENCAISSE", "Encaissé", "success", 100, db.BankStageTypeCASHED, false, true},
...
var seedBankRejectionReasons = []seedBankRejectionReason{
	...
	{banqueMotifAutre, "Autre motif", 900},
}
...
// suit par ordre alphabétique. Voir packages/database/src/seed-data/pays.ts.
...
var seedStatutsQualification = []seedStatutQualification{
	{"ACCEPTE", exportLibelleAccepte, db.StatutQualificationEffectREACHED, false, false, nil, db.PrioriteTraitementHAUTE, seedRelation(db.RepresentantRelationAMBASSADEUR), 10, 6},
	...
	{lotEtatARappeler, "À rappeler", db.StatutQualificationEffectSCHEDULECALLBACK, true, false, nil, db.PrioriteTraitementHAUTE, nil, 30, 6},
