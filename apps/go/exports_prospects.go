...
func exportPorteeDeLecture(p *exportPredicat, u *Utilisateur) {
...
func exportConditionsProspects(u *Utilisateur, in *ExportProspectsInput, segment string) (*exportPredicat, error) {
	p := &exportPredicat{}
	...
	if in.IncludeDeleted != exportFiltreVrai || u.Role != Admin {
...
func (s *service) exportClasseurConsolide(ctx context.Context, c *exportClasseur, u *Utilisateur, in *ExportProspectsInput, libres []exportChampLibre) error {
...
func (s *service) exportClasseurFiltre(ctx context.Context, c *exportClasseur, u *Utilisateur, in *ExportProspectsInput, libres []exportChampLibre) error {
