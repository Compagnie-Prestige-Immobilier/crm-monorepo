...
var colonnesVisitesImport = []colonneImport{
	{entete: enteteDate, requise: true},
	{entete: enteteHeure},
	{entete: enteteNom, requise: true},
	{entete: "TELEPHONES"},
	{entete: "ENTREPRISE", requise: true},
	{entete: "DIRECTION"},
	{entete: enteteDestinataire},
	{entete: enteteObjetMalOrthographie, requise: true},
...
var (
	listesVisitesImport = map[string]string{
		...
		attenduDestinataireImport: enteteDestinataire, attenduObjetImport: enteteObjetMalOrthographie,
	}
...
func lireVisiteImport(cellules map[string]string, numero int, brut any) (any, *erreurLigneImport) {
	...
	if e164, err := normaliserTelephone(brutTelephone, etat.region); err == nil {
