...
// module lève.
func (s *service) banqueAviser(ctx context.Context, etape, auteur string, avis *CreationNotification) {
	if _, err := s.composerNotification(ctx, auteur, avis); err != nil {
