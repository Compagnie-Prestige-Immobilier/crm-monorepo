...
const SESSIONS = {
  ...
  direction: 'e2e/.auth/direction.json',
  superviseur: 'e2e/.auth/superviseur.json',
  accueil: 'e2e/.auth/accueil.json',
...
test.describe('ROL-27', () => {
  ...
  for (const route of ['/chues/campagnes', `/chues/campagnes/${LOT}`, `/grand-public/campagnes/${LOT}`]) {
