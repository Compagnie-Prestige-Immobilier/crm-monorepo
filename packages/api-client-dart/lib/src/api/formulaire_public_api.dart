...
class FormulairePublicApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FormulairePublicDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FormulairePublicDto>> lireFormulairePublic({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/formulaire-public/formulaire';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    FormulairePublicDto? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<FormulairePublicDto, FormulairePublicDto>(
              rawData,
              'FormulairePublicDto',
              growable: true,
            );
    ...
    return Response<FormulairePublicDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
