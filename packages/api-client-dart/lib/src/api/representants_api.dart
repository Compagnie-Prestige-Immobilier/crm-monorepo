...
class RepresentantsApi {
  ...
  Future<Response<RepresentantCommentDto>> addRepresentantComment({
    ...
    return Response<RepresentantCommentDto>(
      data: _responseData,
  ...
  Future<Response<RepresentantDto>> createRepresentant({
    ...
    return Response<RepresentantDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OkDto>> deleteRepresentant({
    ...
    final _queryParameters = <String, dynamic>{
      if (cascade != null) r'cascade': cascade,
    };
  ...
  Future<Response<RepresentantCommentListDto>> listRepresentantComments({
    ...
    return Response<RepresentantCommentListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<DeviceCallDetectionListDto>> listRepresentantDeviceCalls({
    ...
    return Response<DeviceCallDetectionListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Chaque écriture sur la fiche (panneau, mobile, appel de qualification, import) laisse une version : les champs modifiés, avec leur valeur d’avant et d’après.
  ///
  /// Parameters:
  /// * [id]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RepresentantFicheChangeListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RepresentantFicheChangeListDto>>
  listRepresentantFicheChanges({
    ...
    final _path = r'/api/v1/representants/{id}/fiche-history'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
    ...
    RepresentantFicheChangeListDto? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<
              ...
              RepresentantFicheChangeListDto
            >(rawData, 'RepresentantFicheChangeListDto', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<RepresentantFicheChangeListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RepresentantListDto>> listRepresentants({
    ...
    return Response<RepresentantListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [phone] - Téléphone en saisie libre ; normalisé avant recherche.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<RepresentantLookupDto>> lookupRepresentantByPhone({
    ...
    return Response<RepresentantLookupDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
