...
class AdminApi {
  ...
  /// Ne prend aucun paramètre : le fichier servi est celui de l’export courant. Le téléchargement est journalisé au nom de l’administrateur, et le fichier est détruit une fois la réponse entièrement émise. Un téléchargement interrompu ne détruit rien, il peut être repris.
  ///
  /// Parameters:
  ...
  Future<Response<Uint8List>> downloadDatabaseDump({
    ...
    final _path = r'/api/v1/admin/database-dump/download';
  ...
  /// Route de SONDAGE : l’écran des paramètres l’interroge pendant que l’export court. Elle réconcilie aussi l’état avec l’horloge : un fichier échu est détruit ici, et un export interrompu par un redémarrage passe en &#x60;failed&#x60; plutôt que de bloquer indéfiniment toute nouvelle demande.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  Future<Response<DatabaseDumpJobDto>> getDatabaseDump({
    ...
    return Response<DatabaseDumpJobDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// &#x60;allowed&#x60; vaut false pour tout administrateur autre que le premier : l’écran masque alors la commande, et POST /admin/purge refuse de son côté.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  Future<Response<PurgeCatalogDto>> getPurgeCatalog({
    ...
    return Response<PurgeCatalogDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// La présence est déduite des traces existantes : familles de jetons, lots de synchronisation, écritures métier. Aucune colonne dédiée.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  Future<Response<SupervisionDto>> getSupervision({
    ...
    return Response<SupervisionDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PurgeResultDto>> purgeDatabase({
    ...
    return Response<PurgeResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
