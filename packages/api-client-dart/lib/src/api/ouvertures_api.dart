...
class OuverturesApi {
  ...
  /// * [to] - Journée incluse.
  /// * [openedById] - Un seul téléconseiller.
  ...
  Future<Response<ComptageOuverturesDto>> compterOuvertures({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (to != null) r'to': to,
      if (openedById != null) r'openedById': openedById,
    };
    ...
    return Response<ComptageOuverturesDto>(
      data: _responseData,
  ...
  Future<Response<OuvertureFicheDto>> enregistrerBrouillonOuverture({
    ...
    return Response<OuvertureFicheDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OuvertureFicheListDto>> listOuverturesOuvertes({
    ...
    return Response<OuvertureFicheListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Nulle quand aucune fiche n’est ouverte.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
