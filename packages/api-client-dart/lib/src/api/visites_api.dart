...
import 'package:crm_api_client/src/model/visite_sort_field.dart';
...
class VisitesApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OkDto>> deleteVisiteDashboardLayout({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/visites/tableau-de-bord/disposition';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DispositionResponseDto>> getVisiteDashboardLayout({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    return Response<DispositionResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Total toutes dates confondues, à distinguer du décompte borné de /statistiques.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  Future<Response<VisiteReferentielUsageDto>> getVisiteReferentielUsage({
    ...
    return Response<VisiteReferentielUsageDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<VisiteImportChangeListDto>> getVisitesRegistreImportRevue({
    ...
    return Response<VisiteImportChangeListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [DispositionResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DispositionResponseDto>> putVisiteDashboardDefaultLayout({
    ...
    final _path = r'/api/v1/visites/tableau-de-bord/disposition-par-defaut';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  /// Returns a [Future] containing a [Response] with a [DispositionResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DispositionResponseDto>> putVisiteDashboardLayout({
    required UpdateDispositionDto updateDispositionDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
