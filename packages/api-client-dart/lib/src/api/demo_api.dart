...
class DemoApi {
  ...
  /// Supprime EXACTEMENT les lignes enregistrées au moment de l’ensemencement. Aucune donnée réelle n’est touchée, quelle que soit sa ressemblance avec une donnée de démonstration.
  ///
  /// Parameters:
