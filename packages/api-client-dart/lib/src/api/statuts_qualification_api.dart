...
class StatutsQualificationApi {
  ...
  Future<Response<StatutQualificationDto>> createStatutQualification({
    ...
    return Response<StatutQualificationDto>(
      data: _responseData,
  ...
  Future<Response<StatutQualificationListDto>> listAllStatutsQualification({
    ...
    return Response<StatutQualificationListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [payloadVersion] - Version de charge utile de l’appelant. Un statut qu’il ne saurait pas émettre ne lui est jamais proposé : sa remontée finirait en échec définitif, hors ligne.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
