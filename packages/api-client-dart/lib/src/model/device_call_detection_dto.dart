...
class DeviceCallDetectionDto {
  ...
  @JsonKey(name: r'deviceCallAt', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'attemptId', required: true, includeIfNull: true)
  ...
  factory DeviceCallDetectionDto.fromJson(Map<String, dynamic> json) =>
      _$DeviceCallDetectionDtoFromJson(json);
