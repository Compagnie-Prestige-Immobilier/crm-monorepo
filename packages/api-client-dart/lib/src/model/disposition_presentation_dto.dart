...
class DispositionPresentationDto {
  ...
  @JsonKey(
    ...
    required: false,
    includeIfNull: false,
  unknownEnumValue: DispositionPresentationDtoPaletteEnum.unknownDefaultOpenApi,
  )
  ...
  factory DispositionPresentationDto.fromJson(Map<String, dynamic> json) => _$DispositionPresentationDtoFromJson(json);
