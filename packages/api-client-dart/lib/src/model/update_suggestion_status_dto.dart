...
class UpdateSuggestionStatusDto {
  ...
  UpdateSuggestionStatusDto({required this.status});
  ...
  factory UpdateSuggestionStatusDto.fromJson(Map<String, dynamic> json) =>
      _$UpdateSuggestionStatusDtoFromJson(json);
