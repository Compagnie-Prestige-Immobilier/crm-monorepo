  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SetVisiteImportChangeSelectionDto &&
            ...
            equals([ids, selected], [other.ids, other.selected]);
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^ mapPropsToHashCode([ids, selected]);

  factory SetVisiteImportChangeSelectionDto.fromJson(
    Map<String, dynamic> json,
  ) => _$SetVisiteImportChangeSelectionDtoFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SetVisiteImportChangeSelectionDtoToJson(this);
