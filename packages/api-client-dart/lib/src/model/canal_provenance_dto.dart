...
class CanalProvenanceDto {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is CanalProvenanceDto &&
            ...
            equals(
              [id, code, label, position, isActive, updatedAt],
              [
                other.id,
                other.code,
                other.label,
  ...
  int get hashCode =>
      ...
      mapPropsToHashCode([id, code, label, position, isActive, updatedAt]);

  factory CanalProvenanceDto.fromJson(Map<String, dynamic> json) =>
      _$CanalProvenanceDtoFromJson(json);
