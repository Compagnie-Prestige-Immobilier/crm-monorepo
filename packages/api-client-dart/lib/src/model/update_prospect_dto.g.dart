...
part of 'update_prospect_dto.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$UpdateProspectDtoCWProxy {
  UpdateProspectDto id(String? id);

  UpdateProspectDto nom(String? nom);

  UpdateProspectDto prenom(String? prenom);
  ...
  /// Usage
  /// ```dart
  /// UpdateProspectDto(...).copyWith(id: 12, name: "My name")
  /// ````
  UpdateProspectDto call({
    String? id,
    String? nom,
    String? prenom,
    String? phone,
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfUpdateProspectDto.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfUpdateProspectDto.copyWith.fieldName(...)`
class _$UpdateProspectDtoCWProxyImpl implements _$UpdateProspectDtoCWProxy {
  const _$UpdateProspectDtoCWProxyImpl(this._value);

  final UpdateProspectDto _value;

  @override
  UpdateProspectDto id(String? id) => this(id: id);

  @override
  UpdateProspectDto nom(String? nom) => this(nom: nom);

  @override
  UpdateProspectDto prenom(String? prenom) => this(prenom: prenom);
...
extension $UpdateProspectDtoCopyWith on UpdateProspectDto {
  /// Returns a callable class that can be used as follows: `instanceOfUpdateProspectDto.copyWith(...)` or like so:`instanceOfUpdateProspectDto.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$UpdateProspectDtoCWProxy get copyWith =>
      _$UpdateProspectDtoCWProxyImpl(this);
}
