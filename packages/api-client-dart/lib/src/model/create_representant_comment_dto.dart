  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is CreateRepresentantCommentDto &&
            ...
            equals(
              [id, body, clientCreatedAt],
              [other.id, other.body, other.clientCreatedAt],
            );
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^ mapPropsToHashCode([id, body, clientCreatedAt]);

  factory CreateRepresentantCommentDto.fromJson(Map<String, dynamic> json) =>
      _$CreateRepresentantCommentDtoFromJson(json);
