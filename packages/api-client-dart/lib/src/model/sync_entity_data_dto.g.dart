...
part of 'sync_entity_data_dto.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$SyncEntityDataDtoCWProxy {
  SyncEntityDataDto fullName(String? fullName);

  SyncEntityDataDto nom(String? nom);

  SyncEntityDataDto prenom(String? prenom);

  SyncEntityDataDto phone(String? phone);
  ...
  /// Usage
  /// ```dart
  /// SyncEntityDataDto(...).copyWith(id: 12, name: "My name")
  /// ````
  SyncEntityDataDto call({
    String? fullName,
    String? nom,
    String? prenom,
    String? phone,
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfSyncEntityDataDto.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfSyncEntityDataDto.copyWith.fieldName(...)`
class _$SyncEntityDataDtoCWProxyImpl implements _$SyncEntityDataDtoCWProxy {
  const _$SyncEntityDataDtoCWProxyImpl(this._value);

  final SyncEntityDataDto _value;

  @override
  SyncEntityDataDto fullName(String? fullName) => this(fullName: fullName);

  @override
  SyncEntityDataDto nom(String? nom) => this(nom: nom);

  @override
  SyncEntityDataDto prenom(String? prenom) => this(prenom: prenom);

  @override
  SyncEntityDataDto phone(String? phone) => this(phone: phone);
...
extension $SyncEntityDataDtoCopyWith on SyncEntityDataDto {
  /// Returns a callable class that can be used as follows: `instanceOfSyncEntityDataDto.copyWith(...)` or like so:`instanceOfSyncEntityDataDto.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$SyncEntityDataDtoCWProxy get copyWith =>
      _$SyncEntityDataDtoCWProxyImpl(this);
}
