    ...
    return identical(this, other) ||
        other is CreateBankCaseStageDto &&
            ...
            equals(
              ...
              [other.code, other.label, other.color, other.position],
            );
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^ mapPropsToHashCode([code, label, color, position]);

  factory CreateBankCaseStageDto.fromJson(Map<String, dynamic> json) =>
      _$CreateBankCaseStageDtoFromJson(json);
