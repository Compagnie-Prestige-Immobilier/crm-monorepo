...
abstract class _$CreateProspectDtoCWProxy {
  ...
  CreateProspectDto projet(Projet? projet);

  CreateProspectDto type(ProspectType? type);
  ...
  CreateProspectDto employeur(String? employeur);

  CreateProspectDto typeContrat(TypeContrat? typeContrat);

  CreateProspectDto ancienneteMois(num? ancienneteMois);

  CreateProspectDto lieuActivite(String? lieuActivite);

  CreateProspectDto modeEpargne(ModeEpargne? modeEpargne);

  CreateProspectDto paysResidenceId(String? paysResidenceId);

  CreateProspectDto villeResidence(String? villeResidence);

  CreateProspectDto whatsappE164(String? whatsappE164);

  CreateProspectDto relaisNom(String? relaisNom);

  CreateProspectDto relaisPhoneE164(String? relaisPhoneE164);
...
class _$CreateProspectDtoCWProxyImpl implements _$CreateProspectDtoCWProxy {
  ...
  @override
  CreateProspectDto projet(Projet? projet) => this(projet: projet);

  @override
  CreateProspectDto type(ProspectType? type) => this(type: type);
  ...
  @override
  CreateProspectDto employeur(String? employeur) => this(employeur: employeur);
  ...
  @override
  CreateProspectDto relaisNom(String? relaisNom) => this(relaisNom: relaisNom);
...
CreateProspectDto _$CreateProspectDtoFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('CreateProspectDto', json, ($checkedConvert) {
  $checkKeys(json, requiredKeys: const ['nom', 'phone']);
...
Map<String, dynamic> _$CreateProspectDtoToJson(
  CreateProspectDto instance,
) => <String, dynamic>{
