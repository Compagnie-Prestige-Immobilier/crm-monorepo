...
class SupervisionActivityCountsDto {
  ...
  factory SupervisionActivityCountsDto.fromJson(Map<String, dynamic> json) => _$SupervisionActivityCountsDtoFromJson(json);
