...
part 'rep_campaign_progress_dto.g.dart';
...
class RepCampaignProgressDto {
  /// Returns a new [RepCampaignProgressDto] instance.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is RepCampaignProgressDto &&
  ...
  factory RepCampaignProgressDto.fromJson(Map<String, dynamic> json) =>
      _$RepCampaignProgressDtoFromJson(json);

  Map<String, dynamic> toJson() => _$RepCampaignProgressDtoToJson(this);
