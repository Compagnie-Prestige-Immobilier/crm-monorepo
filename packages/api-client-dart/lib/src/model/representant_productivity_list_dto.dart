...
class RepresentantProductivityListDto {
  ...
  @JsonKey(name: r'dormantDays', required: true, includeIfNull: false)
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is RepresentantProductivityListDto &&
            ...
            equals(
              [items, total, dormantDays],
              [other.items, other.total, other.dormantDays],
            );
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^ mapPropsToHashCode([items, total, dormantDays]);

  factory RepresentantProductivityListDto.fromJson(Map<String, dynamic> json) =>
      _$RepresentantProductivityListDtoFromJson(json);

  Map<String, dynamic> toJson() =>
      _$RepresentantProductivityListDtoToJson(this);
