...
class OuvrirFicheDto {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is OuvrirFicheDto &&
            ...
            equals(
              [id, representantId, prospectId, openedAt, draft],
              [
                other.id,
  ...
  int get hashCode =>
      ...
      mapPropsToHashCode([id, representantId, prospectId, openedAt, draft]);

  factory OuvrirFicheDto.fromJson(Map<String, dynamic> json) =>
      _$OuvrirFicheDtoFromJson(json);
