...
class MesAttributionsDto {
  ...
  @JsonKey(name: r'representantIds', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'tout', required: true, includeIfNull: false)
  final bool tout;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is MesAttributionsDto &&
            ...
            equals(
              [representantIds, prospectIds, tout],
              [other.representantIds, other.prospectIds, other.tout],
            );
  }
  ...
  int get hashCode =>
      ...
      mapPropsToHashCode([representantIds, prospectIds, tout]);

  factory MesAttributionsDto.fromJson(Map<String, dynamic> json) =>
      _$MesAttributionsDtoFromJson(json);
