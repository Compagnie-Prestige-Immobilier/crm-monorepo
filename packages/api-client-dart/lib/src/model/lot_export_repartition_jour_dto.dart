...
class LotExportRepartitionJourDto {
  ...
  LotExportRepartitionJourDto({required this.jour, required this.fiches});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is LotExportRepartitionJourDto &&
            ...
            equals([jour, fiches], [other.jour, other.fiches]);
  }

  @override
  int get hashCode => runtimeType.hashCode ^ mapPropsToHashCode([jour, fiches]);

  factory LotExportRepartitionJourDto.fromJson(Map<String, dynamic> json) =>
      _$LotExportRepartitionJourDtoFromJson(json);
