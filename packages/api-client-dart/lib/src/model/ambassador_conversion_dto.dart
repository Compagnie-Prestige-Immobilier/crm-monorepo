...
class AmbassadorConversionDto {
  ...
  @JsonKey(name: r'contacted', required: true, includeIfNull: false)
  final num contacted;
  ...
  @JsonKey(name: r'ambassadors', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'untracked', required: true, includeIfNull: false)
  final num untracked;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is AmbassadorConversionDto &&
            ...
            equals(
              [contacted, ambassadors, conversionRate, reverted, untracked],
              [
                other.contacted,
                other.ambassadors,
  ...
  factory AmbassadorConversionDto.fromJson(Map<String, dynamic> json) =>
      _$AmbassadorConversionDtoFromJson(json);
