...
class ProspectSearchItemDto {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is ProspectSearchItemDto &&
            ...
            equals(
              [id, nom, prenom, fullName, phoneE164, banqueId, banqueName],
              [
                other.id,
                other.nom,
                other.prenom,
  ...
  factory ProspectSearchItemDto.fromJson(Map<String, dynamic> json) =>
      _$ProspectSearchItemDtoFromJson(json);
