...
class ProspectSearchListDto {
  ...
  ProspectSearchListDto({required this.items, required this.meta});
  ...
  factory ProspectSearchListDto.fromJson(Map<String, dynamic> json) =>
      _$ProspectSearchListDtoFromJson(json);
