...
abstract class _$DemandePubliqueDtoCWProxy {
  ...
  DemandePubliqueDto dureeEtablissementMois(num? dureeEtablissementMois);

  DemandePubliqueDto fonctionnaire(bool? fonctionnaire);

  DemandePubliqueDto engagementEnCours(bool? engagementEnCours);

  DemandePubliqueDto syndicatId(String? syndicatId);

  DemandePubliqueDto banqueId(String? banqueId);

  DemandePubliqueDto incomeBandId(String? incomeBandId);

  DemandePubliqueDto type(ProspectType? type);

  DemandePubliqueDto paymentMode(PaymentMode? paymentMode);

  DemandePubliqueDto dureeSystemeMois(num? dureeSystemeMois);

  DemandePubliqueDto whatsappStatus(WhatsappStatus? whatsappStatus);

  DemandePubliqueDto whatsappE164(String? whatsappE164);

  DemandePubliqueDto champsLibres(Map<String, String>? champsLibres);
...
class _$DemandePubliqueDtoCWProxyImpl implements _$DemandePubliqueDtoCWProxy {
  ...
  @override
  DemandePubliqueDto banqueId(String? banqueId) => this(banqueId: banqueId);
  ...
  @override
  DemandePubliqueDto type(ProspectType? type) => this(type: type);
...
DemandePubliqueDto _$DemandePubliqueDtoFromJson(
...
Map<String, dynamic> _$DemandePubliqueDtoToJson(
  DemandePubliqueDto instance,
) => <String, dynamic>{
  'nom': instance.nom,
