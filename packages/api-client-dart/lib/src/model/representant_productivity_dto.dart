...
class RepresentantProductivityDto {
  ...
  @JsonKey(name: r'lastProspectAt', required: true, includeIfNull: true)
  final DateTime? lastProspectAt;

  /// Aucun apport depuis le seuil demandé. Calculé en base, jamais côté client.
  @JsonKey(name: r'dormant', required: true, includeIfNull: false)
  final bool dormant;
  ...
  factory RepresentantProductivityDto.fromJson(Map<String, dynamic> json) =>
      _$RepresentantProductivityDtoFromJson(json);
