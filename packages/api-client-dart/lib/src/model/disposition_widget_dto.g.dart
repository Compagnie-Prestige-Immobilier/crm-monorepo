...
const _$DashboardSourceEnumMap = {
  ...
  DashboardSource.tauxDeJoignabiliteRepresentants:
      'taux-de-joignabilite-representants',
  DashboardSource.tauxDAcceptation: 'taux-d-acceptation',
  DashboardSource.tauxDeRappel: 'taux-de-rappel',
  DashboardSource.repartitionStatutsQualification:
      'repartition-statuts-qualification',
  DashboardSource.jointsNonJoints: 'joints-non-joints',
  ...
  DashboardSource.representantsInjoignables: 'representants-injoignables',
  ...
  DashboardSource.dureeMoyenneSurLaFiche: 'duree-moyenne-sur-la-fiche',
  DashboardSource.dureeMoyenneDeCommunication: 'duree-moyenne-de-communication',
  DashboardSource.appelsParJour: 'appels-par-jour',
