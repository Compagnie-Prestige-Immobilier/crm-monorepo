...
abstract class _$SupervisionActivityRowDtoCWProxy {
  ...
  SupervisionActivityRowDto fiches(num fiches);

  SupervisionActivityRowDto fichesJointes(num fichesJointes);

  SupervisionActivityRowDto ficheReachRate(num? ficheReachRate);
  ...
  SupervisionActivityRowDto repFiches(num repFiches);

  SupervisionActivityRowDto repFichesJointes(num repFichesJointes);

  SupervisionActivityRowDto repFichesNonJointes(num repFichesNonJointes);

  SupervisionActivityRowDto repFichesAcceptees(num repFichesAcceptees);

  SupervisionActivityRowDto repFichesRefusees(num repFichesRefusees);

  SupervisionActivityRowDto repFichesARappeler(num repFichesARappeler);

  SupervisionActivityRowDto repFichesEligibles(num repFichesEligibles);

  SupervisionActivityRowDto repReachabilityRate(num? repReachabilityRate);

  SupervisionActivityRowDto repAcceptanceRate(num? repAcceptanceRate);

  SupervisionActivityRowDto repCallbackFicheRate(num? repCallbackFicheRate);
...
class _$SupervisionActivityRowDtoCWProxyImpl
  ...
  @override
  SupervisionActivityRowDto fiches(num fiches) => this(fiches: fiches);
  ...
  SupervisionActivityRowDto call({
    ...
    return SupervisionActivityRowDto(
      ...
      wrongNumber: wrongNumber == const $CopyWithPlaceholder()
          ...
          // ignore: cast_nullable_to_non_nullable
          : wrongNumber as num,
      refused: refused == const $CopyWithPlaceholder()
          ? _value.refused
          // ignore: cast_nullable_to_non_nullable
          : refused as num,
      ...
      callback: callback == const $CopyWithPlaceholder()
          ? _value.callback
          // ignore: cast_nullable_to_non_nullable
          : callback as num,
      reachRate: reachRate == const $CopyWithPlaceholder()
          ? _value.reachRate
          // ignore: cast_nullable_to_non_nullable
          : reachRate as num?,
      ...
      prospectsCreated: prospectsCreated == const $CopyWithPlaceholder()
          ...
          // ignore: cast_nullable_to_non_nullable
          : prospectsCreated as num,
      representantsContacted:
          representantsContacted == const $CopyWithPlaceholder()
...
SupervisionActivityRowDto _$SupervisionActivityRowDtoFromJson(
  ...
  final val = SupervisionActivityRowDto(
    ...
    other: $checkedConvert('other', (v) => v as num),
