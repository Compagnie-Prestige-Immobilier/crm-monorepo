...
SELECT ${id('prospect')},
       ...
       CASE WHEN i % 4 = 1 THEN (ARRAY['PLATFORM','WHATSAPP','VOICE_OR_ELECTRONIC_MESSAGING','APPOINTMENT'])[1 + (i / 4) % 4]::demo."EnrollmentMethod" END,
       ...
       ${pick('pays', 'i')},
       ${VILLES}[1 + i % 10],
       'AUTRE_NUMERO'::demo."WhatsappStatus",
...
SELECT ${id('call')},
       ...
       CASE WHEN i % 6 = 0 THEN (ARRAY['PLATFORM','WHATSAPP','VOICE_OR_ELECTRONIC_MESSAGING','APPOINTMENT'])[1 + (i / 6) % 4]::demo."EnrollmentMethod" END,
