...
return [
    ...
    */
    ...
    // JWT et JWTAuth gardent le jeton parsé : sans purge, une requête hériterait de
    // l'utilisateur de la précédente. Pas 'tymon.jwt.parser' : il suit déjà la requête
    // via refresh() et le re-résoudre empilerait un rebinding de plus à chaque appel.
    'flush' => [
        'tymon.jwt',
        'tymon.jwt.auth',
    ],
