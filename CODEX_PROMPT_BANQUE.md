# Mandat — surface Banque & Finance de CPI GO
...
Uniquement la surface Banque & Finance :
- `apps/api/src/modules/bank-cases/**`
- `apps/api/src/modules/client-requests/**`
- `apps/api/src/modules/export/` pour ce qui concerne les dossiers bancaires
- `apps/web/src/app/(panel)/dossiers/**`
- `apps/web/src/app/(panel)/demandes-clients/**`
- `apps/web/src/components/bank-cases/**`, `apps/web/src/components/client-requests/**`
...
5. **N'elargis aucune autorisation.** Les inventaires nominatifs de routes
   ...
   `apps/api/src/modules/bank-cases/authorization.test.ts`) sont la verite : un role
