...
var seedCallOutcomeReasons = []seedCallOutcomeReason{
	{"MESSAGERIE", "Boîte vocale", seedCouleurWarning, db.CallOutcomeEffectCLOSEUNREACHABLE, false, false, false, 10, 9, ""},
	{"PAS_DE_REPONSE", "NRP", seedCouleurWarning, db.CallOutcomeEffectCLOSEUNREACHABLE, false, false, false, 11, 9, ""},
	{"WRONG_NUMBER", "Faux numéro", seedCouleurDanger, db.CallOutcomeEffectCLOSEWRONGNUMBER, false, false, false, 12, 9, ""},
	{"AUTRE_NON_JOINT", "Autre injoignable", "neutral", db.CallOutcomeEffectCLOSEUNREACHABLE, false, false, false, 13, 9, ""},
	{seedCodeInteresse, "Intéressé", seedCouleurSuccess, db.CallOutcomeEffectCLOSEINTERESTED, false, false, true, 20, 9, ""},
	{"TERRAIN", "Terrain", seedCouleurSuccess, db.CallOutcomeEffectCLOSEINTERESTED, false, false, true, 21, 9, seedCodeInteresse},
	{"VILLA", "Villa", seedCouleurSuccess, db.CallOutcomeEffectCLOSEINTERESTED, false, false, true, 22, 9, seedCodeInteresse},
	{"CONSTRUCTION", "Construction", seedCouleurSuccess, db.CallOutcomeEffectCLOSEINTERESTED, false, false, true, 23, 9, seedCodeInteresse},
	{"FORMALITES_DOMANIALES", "Formalités domaniales", seedCouleurSuccess, db.CallOutcomeEffectCLOSEINTERESTED, false, false, true, 24, 9, seedCodeInteresse},
	{"HESITANT", "Hésitant", seedCouleurInfo, db.CallOutcomeEffectCLOSEHESITANT, false, false, true, 30, 9, ""},
	{"CALLBACK", "À rappeler", seedCouleurInfo, db.CallOutcomeEffectSCHEDULECALLBACK, false, true, true, 31, 9, ""},
	{"DEMANDE_INFORMATION", "Demande d’information", seedCouleurInfo, db.CallOutcomeEffectCLOSEREACHED, false, false, true, 32, 9, ""},
	{seedCodePartenariat, "Demande de partenariat", seedCouleurInfo, db.CallOutcomeEffectCLOSEREACHED, false, false, true, 33, 9, ""},
	{"A_SUPPRIMER", "À supprimer · Farceur / Non sérieux", seedCouleurDanger, db.CallOutcomeEffectCLOSELOST, false, false, true, 34, 9, ""},
	{seedCodeRendezVous, "Rendez-vous", seedCouleurSuccess, db.CallOutcomeEffectCLOSEAPPOINTMENT, false, true, true, 40, 9, ""},
	{"RV_CPI", "RV CPI", seedCouleurSuccess, db.CallOutcomeEffectCLOSEAPPOINTMENT, false, true, true, 41, 9, seedCodeRendezVous},
	{"RV_SITE", "RV site", seedCouleurSuccess, db.CallOutcomeEffectCLOSEAPPOINTMENT, false, true, true, 42, 9, seedCodeRendezVous},
	{"RV_EXTERNE", "RV externe", seedCouleurSuccess, db.CallOutcomeEffectCLOSEAPPOINTMENT, false, true, true, 43, 9, seedCodeRendezVous},
	{"RDV_TELEPHONIQUE", "RV téléphonique", seedCouleurSuccess, db.CallOutcomeEffectCLOSEAPPOINTMENT, false, true, true, 44, 9, seedCodeRendezVous},
}
